...
public class GenericWrappersInaTech implements Wrappers {
	...
	public long takeSnap(){
		...
		try {
			FileUtils.copyFile(driver.getScreenshotAs(OutputType.FILE) , new File("C:\\Users\\prabhu.b\\Desktop\\Screenshot\\"+number+".jpg"));
	...
	public void enterByXpath(String xpathValue, String data) throws Exception {
		// TODO Auto-generated method stub
		try{
			driver.findElementByClassName(xpathValue).sendKeys(data);
		...
		public void verifyTextByClassname(String classname, String text) {
			// TODO Auto-generated method stub
	            try {
	                ...
	                String loginText = driver.findElementByXPath(classname).getText();
